...
public class TestNCycles {
	...
	@Test
	public void normal() {
		assertArrayEquals(new Integer[] { 1, 2, 3, 1, 2, 3, 1, 2, 3 }, list(
				ncycles(range(1, 4), 3)).toArray(new Integer[0]));
	}

	@Test
	public void empty() {
		assertArrayEquals(new Integer[] {}, list(
				ncycles(new ArrayList<Integer>(), 3)).toArray(new Integer[0]));
	}

	@Test
	public void zero() {
		assertArrayEquals(new Integer[] {}, list(ncycles(range(1, 4), 0))
