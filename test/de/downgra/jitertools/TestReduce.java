...
public class TestReduce {
	...
	public void withoutInital() {
		...
		assertEquals(10 + 10 + 10 + 10 + 10, reduce(new Sum(), Arrays
				.asList(new Integer[] { 10, 10, 10, 10, 10 })));
		assertEquals(1 * 2 * 3 * 4 * 5 * 6, reduce(new Mul(), range(1, 7)));
		assertEquals(5 * 5 * 5 * 5 * 5, reduce(new Mul(), Arrays
	...
	public void withInital() {
		...
		assertEquals(10 + 10 + 10 + 10 + 10 + 23, reduce(new Sum(), Arrays
				.asList(new Integer[] { 10, 10, 10, 10, 10 }), 23));
		assertEquals(1 * 2 * 3 * 4 * 5 * 6 * 42, reduce(new Mul(), range(1, 7),
				42));
		assertEquals(5 * 5 * 5 * 5 * 5 * 23, reduce(new Mul(), Arrays
				.asList(new Integer[] { 5, 5, 5, 5, 5 }), 23));
	}
